...
def experiment():
    ...
    for i in range(ite):
        ...
        np.savetxt('loss_pu_1_%d.csv'%seed, loss_pu, delimiter=',')
        np.savetxt('est_error_pu_1_%d.csv'%seed, est_error_pu, delimiter=',')
        np.savetxt('est_error_pubp_1_%d.csv'%seed, est_error_pubp, delimiter=',')
